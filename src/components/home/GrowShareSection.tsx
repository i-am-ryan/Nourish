  ...
  const growShareFeatures = [
    {
      ...
      description: "Start working together in your neighborhood",
      icon: Sprout,
      color: "green",
      image: "/lovable-uploads/joel-muniz-3k3l2brxmwQ-unsplash.jpg",
      caption: "Volunteers working together."
    },
    {
      ...
      icon: HomeIcon,
      color: "blue",
      image: "/lovable-uploads/annie-spratt-WwSX_X4GrAA-unsplash.jpg",
        ...
        <div className="absolute inset-0 bg-gradient-to-b from-black/40 to-black/60 flex items-center justify-center">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-gray-200 max-w-4xl mx-auto drop-shadow-md">
              Building sustainable food systems with volunteer work, micro food banks, and transparent logistics.
            </p>
          </motion.div>
        </div>
      </div>
